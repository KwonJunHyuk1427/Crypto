...
def smma(df):
    #200
    if df['dw'][998]<df['smma200'][998] and df['smma200'][999]<df['dw'][999] and df['smma200'][999]<df['smma50'][999] and df['smma200'][999]<df['smma21'][999]:
        up200(df)
    if df['up'][998]>df['smma200'][998] and df['smma200'][999]>df['up'][999] and df['smma200'][999]>df['smma50'][999] and df['smma200'][999]>df['smma21'][999]:
        dw200(df)
